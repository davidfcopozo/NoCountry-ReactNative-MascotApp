    ...
    <ScrollView>
      ...
      <Modal
        ...
        <View className="flex justify-center w-full pt-12">
          <View style={{color: colors.text, backgroundColor: colors.background}} className="pt-5 px-5 h-full border-t border-black/10">
            <View className="flex justify-between flex-row items-center">
              <Ionicons onPress={() => setOpenLogin(!openLogin)} name="md-close-sharp" size={34} color={colors.text} />
      ...
      <Modal
        ...
        <ScrollView>
          <View className="flex justify-center w-full pt-12">
            <View style={{color: colors.text, backgroundColor: colors.background}} className="pt-5 px-5 h-full border-t border-black/10">
              <View className="flex justify-between flex-row items-center">
                <Ionicons onPress={() => setOpenRegister(!openRegister)} name="md-close-sharp" size={34} color={colors.text} />
      ...
      <View className="flex gap-y-2">
        <Pressable
          ...
          <Text style={{color: colors.text}} className="font-bold text-center">Iniciar Sesión</Text>
        </Pressable>
        ...
        <Pressable
          ...
          <Link to={{ screen: "AboutUs"}}>
            <Text style={{color: colors.text}} className="flex text-center">Acerca de Nosotros</Text>
          </Link>
        </Pressable>
